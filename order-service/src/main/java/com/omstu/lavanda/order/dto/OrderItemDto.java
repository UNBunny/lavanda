...
/**
 * DTO для позиции заказа в API LAVANDA ERP
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class OrderItemDto {
    ...
    @NotNull(message = "Общая стоимость позиции обязательна")
    @DecimalMin(value = "0.0", message = "Общая стоимость не может быть отрицательной")
    @Digits(integer = 10, fraction = 2, message = "Некорректный формат общей стоимости")
